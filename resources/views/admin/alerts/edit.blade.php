                ...
                <div class="row">
                   ...
                   <div class="card">
                        <div class="card-header">
                            ...
                            <h4>Editar <strong>{{$alert->name}}</strong></h4>
                        </div><!---->
                        <div class="card-body">
                            <form action="{{route('alerts.update',$alert->id)}}" method="POST">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    name="name" placeholder="First Name" value="{{$alert->name}}">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    name="date_start" value="{{$alert->date_start}}">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    name="date_finish" value="{{$alert->date_finish}}">
                                </div>
